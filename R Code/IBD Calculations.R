...
#28 fish counted at random sites- scale this up based on 0.25 fish per square km 
#multiply by 300 km2 of reef (reef area) to get 75 fish in the entire study area
#then divide by the reef length
